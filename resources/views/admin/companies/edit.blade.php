    ...
    <div class="card-body">
        <form action="{{ route("admin.companies.update", [$company->id]) }}" method="POST"
            ...
            <div class="form-group {{ $errors->has('registration') ? 'has-error' : '' }}">
                <label for="registration">{{ trans('cruds.company.fields.registration') }}*</label>
                <input type="text" id="registration"
                    value="{{ old('registration', isset($company) ? $company->registration : '') }}" name="registration"
                    class="form-control "
                    required>{{ old('registration', isset($company) ? $company->registration : '') }}
                ...
                <p class="helper-block">
                    {{ trans('cruds.company.fields.registration_helper') }}
                </p>
            </div>
