...
@section('content')
<div class="site-blocks-cover overlay" style="background-image: url({{ $client->getFirstMediaUrl('main_photo') }});"
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-10">
                ...
                <p class="mb-5"><strong class="h2 text-success font-weight-bold">${{ $client->price_per_hour }}</strong>
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-8" style="margin-top: -150px;">
                <div class="mb-5">
                    <div class="slide-one-item home-slider owl-carousel">
                        <div><img src="{{ $client->getFirstMediaUrl('main_photo', 'big_thumb') }}"
                                alt="{{ $client->name }}" class="img-fluid"></div>
                    </div>
                </div>
                <div class="bg-white">
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <strong class="text-success h1 mb-3">${{ $client->price_per_hour }}</strong>
                        </div>
                    </div>
                    <div class="row mb-5">
                        <div class="col-md-6 col-lg-4 text-left border-bottom border-top py-3">
                            ...
                            <strong
                                class="d-block">{{ implode(', ', $client->event_types->pluck('name')->toArray()) }}</strong>
                        </div>
                        <div class="col-md-6 col-lg-4 text-left border-bottom border-top py-3">
                            <span class="d-inline-block text-black mb-0 caption-text">Location</span>
                            <strong class="d-block">{{ $client->location->name }}</strong>
                        </div>
                        <div class="col-md-6 col-lg-4 text-left border-bottom border-top py-3">
                            <span class="d-inline-block text-black mb-0 caption-text">People amount</span>
                            <strong class="d-block">{{ $client->people_minimum }} - {{ $client->people_maximum }}</strong>
                        </div>
                    </div>
                    ...
                    <div class="row mt-5">
                        <div class="col-12">
                            ...
                            <script>
                                var map;
                                  var default_center_latitude = {{ $client->latitude }};
                                  var default_center_longitude = {{ $client->longitude }};
                                  var default_zoom = 10;
                                  ...
                                  function initMap() {
                                    ...
                                    var marker = {"latitude": {{ $client->latitude }}, "longitude": {{ $client->longitude }} };
...
<div class="site-section site-section-sm bg-light">
    <div class="container">
        ...
        <div class="row mb-5">
            @foreach ($relatedClients as $client)
            <div class="col-md-6 col-lg-4 mb-4">
                <a href="{{ route('clients.show', [$client->slug, $client->id]) }}" class="prop-entry d-block">
                    <figure>
                        <img src="{{ $client->getFirstMediaUrl('main_photo', 'big_thumb') }}" alt="{{ $client->name }}"
                            class="img-fluid">
                    </figure>
                    <div class="prop-text">
                        <div class="inner">
